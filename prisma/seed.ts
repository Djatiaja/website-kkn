...
async function main() {
  ...
  const products = [
    {
      ...
      descriptionId: "Kopi robusta premium yang ditanam di ketinggian 900–1.100 mdpl di lembah Gunung Sumbing, Windusari, Magelang. Diproses secara natural dengan rasa cokelat dan aroma earthy yang khas. Hasil panen petani lokal Desa Pasangsari.",
      descriptionEn: "Premium robusta coffee grown at 900–1,100 meters above sea level in the valley of Mount Sumbing, Windusari, Magelang. Naturally processed with distinctive chocolate taste and earthy aroma. Harvested by local farmers of Pasangsari Village.",
    ...
    {
      nameId: "Homestay Joglo Pasangsari", nameEn: "Joglo Pasangsari Homestay",
    ...
    {
      nameId: "Nasi Gurih Khas Pasangsari", nameEn: "Pasangsari Special Nasi Gurih",
  ...
  const newsArticles = [
    {
      titleId: "Desa Pasangsari Raih Penghargaan Desa Digital Terbaik 2024",
      titleEn: "Pasangsari Village Wins Best Digital Village Award 2024",
      slug: "penghargaan-desa-digital-2024",
      contentId: "<p>Desa Pasangsari berhasil meraih penghargaan sebagai Desa Digital Terbaik tingkat Kabupaten Magelang tahun 2024. Penghargaan ini diberikan atas keberhasilan desa dalam mengimplementasikan sistem informasi desa terintegrasi, transparansi keuangan digital, dan pelayanan publik berbasis online.</p><p>Kepala Desa menyampaikan rasa syukur dan bangga atas pencapaian ini. \"Ini adalah hasil kerja keras seluruh perangkat desa dan partisipasi aktif masyarakat dalam mendukung digitalisasi desa,\" ujarnya.</p>",
      contentEn: "<p>Pasangsari Village has won the Best Digital Village award at the Magelang Regency level in 2024. The award was given for the village's success in implementing an integrated village information system, digital financial transparency, and online-based public services.</p><p>The Village Head expressed gratitude and pride for this achievement. \"This is the result of hard work by all village officials and active community participation in supporting village digitalization,\" he said.</p>",
      excerptId: "Desa Pasangsari berhasil meraih penghargaan Desa Digital Terbaik tingkat Kabupaten Magelang.",
      excerptEn: "Pasangsari Village wins Best Digital Village award at Magelang Regency level.",
    ...
    },
    {
      ...
      contentId: "<p>Pemerintah Desa Pasangsari menginformasikan jadwal Posyandu dan vaksinasi untuk bulan Juni 2024.</p><p>Warga diminta membawa KTP, KK, dan buku KIA untuk anak balita.</p>",
      contentEn: "<p>Pasangsari Village Government informs the Health Post and vaccination schedule for June 2024.</p><p>Residents are asked to bring their ID card, family card, and child health book.</p>",
  ...
  const galleryItems = [
    ...
    { titleId: "Profil Desa Pasangsari", titleEn: "Pasangsari Village Profile", type: "VIDEO" as const, url: "https://youtu.be/dQw4w9WgXcQ", thumbnailUrl: "https://placehold.co/600x400?text=Video+Profil", category: "Profil" },
